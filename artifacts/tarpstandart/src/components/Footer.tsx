        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://web.max.ru/-73641918407966" target="_blank" rel="noopener noreferrer" aria-label="MAX" className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/30 transition-all">

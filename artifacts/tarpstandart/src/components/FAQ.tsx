...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Да, популярные виды тканей ПВХ и других материалов всегда в наличии на наших складах в Москве, Санкт-Петербурге, Минске и Уфе. Точные адреса для водителей — в блоке «Контакты»."
    },
    {
